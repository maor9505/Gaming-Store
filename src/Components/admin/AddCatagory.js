        ...
        <div className='container'>
            ...
            <form autoComplete="off" className='form-group' onSubmit={addCatagory}>
                ...
                <input type="text" className='form-control' required
                    onChange={(e) => setCatagoryName(e.target.value)} value={catagoryName} />
                <br />
                <button type="submit" className='btn btn-success btn-md '>ADD</button>
                <button onClick={handleBack} className='btn btn-success btn-md  m-4'>Back</button>
